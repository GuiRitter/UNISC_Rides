...
public final class WebServiceInterface {
    ...
    static final String serverIP = "192.168.137.232";

    private static PrintWriter serverIn = null;

    private static BufferedReader serverOut = null;
    ...
    static final void initialize (MessageInterface messageInterface) throws IOException {
        if (messageInterface == null) throw new RuntimeException();
        WebServiceInterface.messageInterface = messageInterface;
        new Thread(new ResponseAppListener()).start();
        ...
        new Thread(new ResponseServerListener(serverOut)).start();
    }
    ...
    public static final void main (String args[]) throws IOException {
        initialize(new MessageInterface() {
...
//        System.out.println(readAllocation(null, list));
//        for (Allocation a : list) {
//            System.out.println(a);
//        }
//        {
//            ArrayList<Login> list = new ArrayList<>();
//            System.out.println(readLogin(null, list));
//            for (Login a : list) {
//                System.out.println(a);
//            }
//        }
//        ArrayList<Offer> list = new ArrayList<>();
//        System.out.println(readOffer(null, list));
//        for (Offer a : list) {
//            System.out.println(a);
//        }
//        ArrayList<Origin> list = new ArrayList<>();
//        System.out.println(readOrigin(null, list));
//        for (Origin a : list) {
//            System.out.println(a);
//        }
//        ArrayList<Person> list = new ArrayList<>();
//        System.out.println(readPerson(null, list));
//        for (Person a : list) {
//            System.out.println(a);
//        }
//        ArrayList<Message> list = new ArrayList<>();
//        System.out.println(readMessage(null, list));
//        for (Message m : list) {
//            System.out.println(m);
//        }
        //
//        person = new Person(-1, "Alice", -1, null, null);
//        person = new Person(-1, "Bob", 9876543, "b@t.com", "128.0.0.1");
//        System.out.println(createPerson(person));
//        login = new Login(6, "guir", "birthday");
//        System.out.println(createLogin(login));
//        origin = new Origin(-1, 1, null, -1, "Ana Nery", "Santa Cruz do Sul");
//        origin = new Origin(-1, 6, "Independência", 1234, "Universitário", "Santa Cruz do Sul");
//        System.out.println(createOrigin(origin));
//        offer = new Offer(-1, 6, 5, (byte) 0, (byte) 0, null, Offer.Shift.M, null, false, true);
//        System.out.println(createOffer(offer));
//        allocation = new Allocation(6, 3, Allocation.Status.APPROVED);
//        System.out.println(createAllocation(allocation));
//        message = new Message(21, 21, null, null, "Hello, World!");
//        System.out.println(createMessage(message));
        //
//        login = new Login(6, null, null);
//        System.out.println(deleteLogin(login));
//        allocation = new Allocation(-1, -1, Allocation.Status.REJECTED);
//        System.out.println(deleteAllocation(allocation));
//        offer = new Offer();
//        offer.shift = Offer.Shift.N;
//        System.out.println(deleteOffer(offer));
//        origin = new Origin();
//        origin.id = 5;
//        System.out.println(deleteOrigin(origin));
//        person = new Person();
//        person.id = 6;
...
//        System.out.println(deleteMessage(message));
        //
//        Login selectLogin = new Login(-1, "evertonn", null);
//        Login updatedLogin = new Login(1, null, null);
//        System.out.println(updateLogin(selectLogin, updatedLogin));
//        Person selectPerson = new Person();
//        selectPerson.id = 1;
//        Person updatedPerson = new Person();
//        updatedPerson.email = "a@t.com";
//        System.out.println(updatePerson(selectPerson, updatedPerson));
//        Origin selectOrigin = new Origin();
//        selectOrigin.id = 1;
//        Origin updatedOrigin = new Origin();
//        updatedOrigin.person = 1;
//        updatedOrigin.number = 5678;
//        System.out.println(updateOrigin(selectOrigin, updatedOrigin));
//        Offer selectOffer = new Offer();
//        selectOffer.id = 1;
//        Offer updatedOffer = new Offer();
//        updatedOffer.person = 1;
//        updatedOffer.origin = 1;
//        updatedOffer.remainingSeats = 0;
//        System.out.println(updateOffer(selectOffer, updatedOffer));
//        Allocation updatedAllocation
//         = new Allocation(1, 1, Allocation.Status.APPROVED);
//        System.out.println(updateAllocation(null, updatedAllocation));
    }
}
