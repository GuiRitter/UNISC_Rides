...
public class ChatMessageAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public ChatMessageAdapter(Context context, ArrayList<ChatMessage> users) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        chat_banner.peer_name.setText(person.name + " (" + getItem(position).last_msg.date + " " + getItem(position).last_msg.time + ")");
        chat_banner.last_msg.setText(getItem(position).last_msg.message);
